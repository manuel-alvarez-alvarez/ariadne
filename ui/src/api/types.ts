...
export type KnowledgeStatusDto = Schemas["KnowledgeStatusDto"]
export type KnowledgeState = Schemas["KnowledgeState"]
export type KnowledgeInteractionGroupDto = Schemas["KnowledgeInteractionGroupDto"]
export type KnowledgeEdgeDto = Schemas["KnowledgeEdgeDto"]
export type KnowledgeEndpointDto = Schemas["KnowledgeEndpointDto"]
export type KnowledgeHitDto = Schemas["KnowledgeHitDto"]
export type KnowledgeSymbolDto = Schemas["KnowledgeSymbolDto"]
