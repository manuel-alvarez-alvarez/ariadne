...
What Ariadne is and what it looks like is [`README.md`](../README.md). These
pages are the manual: how to install it, how to drive it, and every key it
reads.
...
| [Memory](memory.md) | facts an agent or you save about a repository or globally, who writes one, and `ariadne memory add\|ls\|search\|delete` |
