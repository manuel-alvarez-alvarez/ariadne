...
the goals it will actually delete, and `session ls --agent` the registry
agents. On session and task logs, `--kind` completes stored transcript kinds
and live chunk kinds.
